...
OUTPUT_MASK = os.path.join(OUTPUT_PATH, 'output_mask.avi')
...
OUTPUT_MASK_BLOB_DETECTION = os.path.join(OUTPUT_PATH, 'output_blobs.avi')
...
BLOB_DET_PARAMS.minThreshold = 50
